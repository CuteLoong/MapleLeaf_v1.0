...
void PipelineRayTracing::CmdRender(const CommandBuffer& commandBuffer, const glm::uvec3& extent) const
{
    vkCmdTraceRaysKHR(commandBuffer, &rgenRegion, &missRegion, &hitRegion, &callRegion, extent.x, extent.y, extent.z);
}
